package net.mcreator.minecraftdrugs;
...
@Mod("minecraft_drugs")
public class MinecraftDrugsMod {
	public static final Logger LOGGER = LogManager.getLogger(MinecraftDrugsMod.class);
	public static final String MODID = "minecraft_drugs";

	public MinecraftDrugsMod(IEventBus modEventBus) {
