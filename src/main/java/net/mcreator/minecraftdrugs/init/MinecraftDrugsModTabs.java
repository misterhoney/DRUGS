...
public class MinecraftDrugsModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CITRINIUM = REGISTRY.register("citrinium",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.minecraft_drugs.citrinium")).icon(() -> new ItemStack(MinecraftDrugsModItems.NETHER_WART_EXTRACT.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(MinecraftDrugsModBlocks.MIXING_TABLE.get().asItem());
				tabData.accept(MinecraftDrugsModItems.COPPER_BATTERY.get());
				tabData.accept(MinecraftDrugsModItems.COPPER_BATTERY_DEAD.get());
				...
				tabData.accept(MinecraftDrugsModItems.VAPE_POD_GLOW_BLOW_FLAVOR.get());
				tabData.accept(MinecraftDrugsModItems.VAPE_POD_MELON.get());
				tabData.accept(MinecraftDrugsModItems.VAPE_POD_PILLAGER.get());
				tabData.accept(MinecraftDrugsModItems.VAPE_POD_MAGMA.get());
				tabData.accept(MinecraftDrugsModItems.VAPE_PODWITCH.get());
				tabData.accept(MinecraftDrugsModItems.VAPE_POD_PITCHER.get());
				tabData.accept(MinecraftDrugsModItems.VAPE_POD_PHANTOM.get());
				tabData.accept(MinecraftDrugsModItems.VAPE_POD_GAURDIAN.get());
				tabData.accept(MinecraftDrugsModItems.VAPE_POD.get());
				tabData.accept(MinecraftDrugsModItems.CRYSTALLIZED_BLAZEMPHETAMINE.get());
				tabData.accept(MinecraftDrugsModItems.CRYSTALLIZED_BREEZEMPHETAMINE.get());
				tabData.accept(MinecraftDrugsModItems.BUCKETOF_CRYSTALLIZED_BLAZEMPHETAMINE.get());
				tabData.accept(MinecraftDrugsModItems.BUCKETOF_CRYSTALLIZED_BREEZEMPHETAMINE.get());
				tabData.accept(MinecraftDrugsModItems.BUCKETOF_LIQUID_BLAZEMPHETAMINE.get());
				tabData.accept(MinecraftDrugsModItems.BUCKETOF_LIQUID_BREEZEMPHETAMINE.get());
				tabData.accept(MinecraftDrugsModItems.PIPE.get());
				tabData.accept(MinecraftDrugsModItems.PIPEOF_BLAZEMPHETAMINE.get());
				tabData.accept(MinecraftDrugsModItems.PIPEOF_BREEZEMPHETAMINE.get());
