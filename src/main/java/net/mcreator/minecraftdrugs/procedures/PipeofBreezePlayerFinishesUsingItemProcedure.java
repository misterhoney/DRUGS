...
public class PipeofBreezePlayerFinishesUsingItemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == Items.FLINT_AND_STEEL) {
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (MinecraftDrugsModParticleTypes.MPHETIMENBLAZE.get()), (x + entity.getLookAngle().x), (y + 1.5), (z + entity.getLookAngle().z), 3, 0.1, 0.1, 0.1, 0.1);
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (MinecraftDrugsModParticleTypes.MPHETIMENBLAZE.get()), (x + entity.getLookAngle().x), (y + 1.8), (z + entity.getLookAngle().z), 3, 0.1, 0.1, 0.1, 0.1);
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.SOUL_FIRE_FLAME, (x + entity.getLookAngle().x), (y + 1.2), (z + entity.getLookAngle().z), 3, 0.1, 0.1, 0.1, 0.05);
			if (world instanceof ServerLevel _level) {
