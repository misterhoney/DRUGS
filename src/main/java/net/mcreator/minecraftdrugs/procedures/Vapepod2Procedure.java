...
public class Vapepod2Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (MinecraftDrugsModParticleTypes.VAPE_2P.get()), ((x + entity.getLookAngle().x) - 0.1), (y + 1.5), ((z + entity.getLookAngle().z) - 0.1), 8, 0.01, 0.01, 0.01, 0.05);
		...
		if (!(entity instanceof LivingEntity _livEnt11 && _livEnt11.hasEffect(MinecraftDrugsModMobEffects.ADDICTION))) {
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MinecraftDrugsModMobEffects.EUPHORIA, 600, 0, true, true));
			...
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MinecraftDrugsModMobEffects.EUPHORIA, 300, 0, true, true));
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
		...
		if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(MinecraftDrugsModMobEffects.ADDICTION) ? _livEnt.getEffect(MinecraftDrugsModMobEffects.ADDICTION).getAmplifier() : 0) == 1) {
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MinecraftDrugsModMobEffects.EUPHORIA, 100, 0, true, true));
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
		...
		if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(MinecraftDrugsModMobEffects.ADDICTION) ? _livEnt.getEffect(MinecraftDrugsModMobEffects.ADDICTION).getAmplifier() : 0) == 2) {
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MinecraftDrugsModMobEffects.EUPHORIA, 50, 0, true, true));
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MinecraftDrugsModMobEffects.ADDICTION, 6000, 2, true, true));
		}
		if (entity instanceof LivingEntity _livEnt22 && _livEnt22.hasEffect(MinecraftDrugsModMobEffects.CRAVING)) {
			if (entity instanceof LivingEntity _entity)
				_entity.removeEffect(MinecraftDrugsModMobEffects.CRAVING);
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MinecraftDrugsModMobEffects.EUPHORIA, 1200, 0, true, true));
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MinecraftDrugsModMobEffects.ADDICTION, 6000, 2, true, true));
		}
	}
